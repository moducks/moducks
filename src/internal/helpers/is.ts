...
export const isGenerator = (obj: unknown): obj is Generator<unknown, unknown, unknown> =>
  isObject(obj) && isFunction(obj.next) && isFunction(obj.throw);

export const isGeneratorFunction = (obj: unknown): obj is (...args: any) => Generator<unknown, unknown, unknown> =>
  isFunction(obj) &&
...
export const isEffect = (obj: unknown): obj is StrictEffect =>
  isObject(obj) && obj[IO] === true && typeof obj.type === 'string' && obj.hasOwnProperty('payload');
